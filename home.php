    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#projects">PRODUCTS</a>
                </li>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="text-container">
                        ...
                        <div class="testimonial-author">Divya Mittal - CEO</div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>In this phase you will focus on executing the actions plan and evaluating the results
                                after each marketing campaign</p>
                        </div>
                    </div>
                    <!-- end of card -->
...
?>
                    ...
                    <div class="grid">
                        ...
                        <div class="element-item design marketing seo">
                            <a class="popup-with-move-anim" href="#project-6">
                                <div class="element-item-overlay"><span>Events Bussiness Solutions</span></div><img
                                    style="height:270px;" src="images/Events.jpeg" alt="alternative">
                            </a>
                        </div>
                        <div class="element-item design marketing">
                            <a class="popup-with-move-anim" href="#project-7">
                                <div class="element-item-overlay"><span>Travel Company Solutions</span></div><img
                                    src="images/project-7.jpg" alt="alternative">
                            </a>
                        </div>
                        <div class="element-item design marketing">
                            <a class="popup-with-move-anim" href="#project-8">
                                <div class="element-item-overlay"><span>Casual Cloths Solution</span></div><img
                                    style="height:270px;" src="images/Clothes.jpeg" alt="alternative">
                            </a>
                        </div>
                        <div class="element-item design marketing">
    ...
    <div id="project-1" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <a class="btn-solid-reg" href="Products/Product1.php">DETAILS</a> <a
    ...
    <div id="project-2" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <a class="btn-solid-reg" href="Products/Product2.php">DETAILS</a> <a
                    class="btn-outline-reg mfp-close as-button" href="#projects">BACK</a>
            </div> <!-- end of col -->
        </div> <!-- end of row -->
    </div> <!-- end of lightbox-basic -->
    ...
    <div id="project-3" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
            <div class="col-lg-8">
                <img class="img-fluid" src="images/Music.jpeg" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
                <h3>Music Company Solutions</h3>
                <hr class="line-heading">
                <h6>Strategy Development</h6>
                <p>Need a solid foundation for your business growth plans? Aria will help you manage sales and meet
                    your
                ...
                <a class="btn-solid-reg" href="Products/Product3.php">DETAILS</a> <a
                    class="btn-outline-reg mfp-close as-button" href="#projects">BACK</a>
            </div> <!-- end of col -->
        </div> <!-- end of row -->
    </div> <!-- end of lightbox-basic -->
    ...
    <div id="project-4" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <a class="btn-solid-reg" href="Products/Product4.php">DETAILS</a> <a
                    class="btn-outline-reg mfp-close as-button" href="#projects">BACK</a>
            </div> <!-- end of col -->
        </div> <!-- end of row -->
    </div> <!-- end of lightbox-basic -->
    ...
    <div id="project-5" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
            <div class="col-lg-8">
                <img class="img-fluid" src="images/Fitness.jpg" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
                <h3>Fitness Center Bussiness Solutions</h3>
                <hr class="line-heading">
                <h6>Strategy Development</h6>
                <p>Need a solid foundation for your business growth plans? Aria will help you manage sales and meet
                    your
                ...
                <a class="btn-solid-reg" href="Products/Product5.php">DETAILS</a> <a
                    class="btn-outline-reg mfp-close as-button" href="#projects">BACK</a>
            </div> <!-- end of col -->
        </div> <!-- end of row -->
    </div> <!-- end of lightbox-basic -->
    ...
    <div id="project-6" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
            <div class="col-lg-8">
                <img class="img-fluid" src="images/Events.jpeg" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
                <h3>Events Bussiness Solutions</h3>
                <hr class="line-heading">
                <h6>Strategy Development</h6>
                <p>Need a solid foundation for your business growth plans? Aria will help you manage sales and meet
                    your
                ...
                <a class="btn-solid-reg" href="Products/Product6.php">DETAILS</a> <a
                    class="btn-outline-reg mfp-close as-button" href="#projects">BACK</a>
            </div> <!-- end of col -->
        </div> <!-- end of row -->
    </div> <!-- end of lightbox-basic -->
    ...
    <div id="project-7" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <a class="btn-solid-reg" href="Products/Product7.php">DETAILS</a> <a
                    class="btn-outline-reg mfp-close as-button" href="#projects">BACK</a>
            </div> <!-- end of col -->
        </div> <!-- end of row -->
    </div> <!-- end of lightbox-basic -->
    ...
    <div id="project-8" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
            <div class="col-lg-8">
                <img class="img-fluid" src="images/Clothes.jpeg" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
                <h3>Casual Cloths Solution</h3>
                <hr class="line-heading">
                <h6>Strategy Development</h6>
                <p>Need a solid foundation for your business growth plans? Aria will help you manage sales and meet
                    your
                ...
                <a class="btn-solid-reg" href="Products/Product8.php">DETAILS</a> <a
                    class="btn-outline-reg mfp-close as-button" href="#projects">BACK</a>
            </div> <!-- end of col -->
        </div> <!-- end of row -->
    </div>
    ...
    <div id="project-9" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <a class="btn-solid-reg" href="Products/Product9.php">DETAILS</a> <a
                    class="btn-outline-reg mfp-close as-button" href="#projects">BACK</a>
            </div> <!-- end of col -->
        </div> <!-- end of row -->
    </div>
    ...
    <div id="project-10" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <a class="btn-solid-reg" href="Products/Product10.php">DETAILS</a> <a
                    class="btn-outline-reg mfp-close as-button" href="#projects">BACK</a>
            </div> <!-- end of col -->
        </div> <!-- end of row -->
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p class="p-heading">We're only as strong and as knowledgeable as our team. So here are the men
                        and
